    ...
    >
      <div className="flex flex-col gap-[20px] max-w-[30%] mt-[3%]">
        ...
        <div className="flex flex-row gap-[20px] ">
          <button className="w-[50px] h-[50px] bg-white rounded-[50%] flex flex-row items-center justify-center text-[25px] ">
            <FaArrowLeftLong />
          </button>
          <button className="w-[50px] h-[50px] bg-white rounded-[50%] flex flex-row items-center justify-center text-[25px] ">
            <FaArrowRightLong />
      ...
      <div className="min-w-[37%] relative">
        <div className="relative w-[300px] h-[310px] bg-white flex flex-col gap-[15px] z-10 ">
          <div className="bg-[#D4AF37] mx-[4px] mt-[4px] px-[15px] py-[8px] ">
            <h4 className="text-white font-['Raleway'] font-semibold">
              Priya Srivastava
            </h4>
          </div>
          <img className="w-[120px] mx-[20px] " src={icons.stars} alt="" />
          <p className="mx-[20px] text-[19px] font-['Great+Vibes'] mt-[10px] ">
          ...
          <div className="border-b-[35px] border-b-transparent border-r-[80px] border-r-white absolute bottom-[-34px] left-[40%] "></div>
        </div>
