...
function ServicesTrainingBookpopUp({ setPopUp }) {
  ...
  return (
    <div className="bg-white rounded-[10px] w-[600px] max-[800px]:w-[500px] max-[560px]:w-[460px] max-[520px]:w-[400px] max-[450px]:w-[380px] max-[438px]:w-[360px] max-[420px]:w-[340px] max-[400px]:w-[320px] max-[380px]:w-[300px] h-[330px] max-[801px]:h-[470] max-[400px]:h-[355px] fixed top-[50px] left-[400px] max-[1025px]:left-[100px] max-[680px]:left-[70px] max-[600px]:left-[30px] z-50 ">
      <div className="flex flex-col gap-[30px] relative mx-[40px] max-[500px]:mx-[20px]">
        ...
        <a
          href={`https://wa.me/919934059935?text=Hello Ornate, I ${name} want to book a session on ${selectedDate}. `}
          target="_blank"
...
export default ServicesTrainingBookpopUp;
