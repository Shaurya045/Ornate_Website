...
function HomeAbout() {
  return (
    <div className="flex flex-col px-[100px] my-[200px] gap-[60px] w-full">
      <div className="flex flex-row gap-[50px]">
        <div>
          <div className="w-[500px] h-[500px] rounded-[50%] bg-gray-300 overflow-hidden">
            <img src={icons.aboutImg} alt="" />
          </div>
        ...
        <div className="flex flex-col gap-[40px] ">
          ...
          <div className="flex flex-row gap-[50px]">
            <button className="text-white bg-[#B8B3AE] w-[250px] h-[60px] rounded-[10px] text-[16px] font-[500] ">
              LEARN MORE
            </button>
      ...
      <div className="relative flex flex-row w-full h-[230px] bg-[#D4AF37] rounded-[12px] overflow-hidden">
        <div className="ml-0 relative flex flex-row w-[320px] h-full bg-[#B69836] ">
          ...
          <img className="absolute left-[30%] top-[25%]" src={icons.clock} alt="" />
        </div>
        <div className="pl-[40px] flex flex-row gap-[80px] items-center text-white z-10">
          <h2 className="text-[28px] font-bold font-['Playfair+Display'] ">OPENING HOURS</h2>
          <div className="flex-flex-col">
            <h3 className="text-[18px] font-semibold font-['Raleway'] ">MONDAY TO FRIDAY</h3>
            <p className="text-[25px] font-bold font-['Raleway'] ">09:00 AM - 06:00 PM</p>
          </div>
          <div className="flex flex-col">
            <h3 className="text-[18px] font-semibold font-['Raleway'] ">SATURDAY</h3>
            <p className="text-[25px] font-bold font-['Raleway'] ">11:00 AM - 03:00 PM</p>
          </div>
        </div>
        <img className="absolute right-0 bottom-0 h-[150px]" src={icons.flower2} alt="" />
      </div>
    </div>
  );
}
